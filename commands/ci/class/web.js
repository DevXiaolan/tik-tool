...
job_deploy:
  ...
  script:
    ...
    - rm -fr node_modules
    - rancher --url http://172.20.160.7:8080/v2-beta --access-key A7B232C96113121C64A2 --secret-key 8mAJL2iDVr7k5BT7Ws32h41MyfJY1ubWBGBAM8U -d  --pull --force-upgrade --confirm-upgrade --stack ${pkg.group}-${pkg.name}
